...
public class TelaCadastroMotorista extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleMaskFormatter smf_medida = new SimpleMaskFormatter("NNNNNN");
    ...
    public void cadastrarMotoristaVeiculo(View view){
        ...
        if(placa_valid && marca_valid && modelo_valid && comprimento_valid && largura_valid && altura_valid && peso_valid){
            ...
            Toast.makeText(TelaCadastroMotorista.this, mensagem, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void testeCadastro(Veiculo veiculo){
        ...
        Intent intent_motorista = new Intent(TelaCadastroMotorista.this, RequisicoesActivity.class);
