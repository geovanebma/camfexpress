...
public class Validacoes {
    //Essa classe foi criada para validar os tipos de dados entrados nos campos de cadastro

    //Verifica o número de telefone/celular
    ...
    //Verifica se tal campo foi preenchido
    ...
    //Verifica se os campos de e-mail foram digitados corretamente
    ...
    //Verifica se os campos de CEP foram digitados corretamente
    ...
    //Verifica se os campos de CPF/CNPJ foram digitados corretamente
    ...
    //Verifica se os campos de data foram digitados corretamente
