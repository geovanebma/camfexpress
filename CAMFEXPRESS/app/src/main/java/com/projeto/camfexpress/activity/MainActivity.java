...
public class MainActivity extends AppCompatActivity {
    ...
    private Button buttonMotorista;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonMotorista = findViewById(R.id.buttonMotorista);
        buttonCliente = findViewById(R.id.buttonCliente);

        mAuth = ConfiguracaoFirebase.getFirebaseAutenticacao();
    }

    //Botão de escolha para motorista
    public void buttonMotorista(View view){
        if(((CheckBox) checkBoxConcordancia).isChecked()){
            if(mAuth.getCurrentUser() != null){
                ...
                intent.putExtra("modalidade", "Motorista");
    ...
    public void concordarTexto(View view){
        if(((CheckBox) checkBoxConcordancia).isChecked()){
            buttonMotorista.setEnabled(true);
            buttonCliente.setEnabled(true);
        }else{
            buttonMotorista.setEnabled(false);
