package com.projeto.camfexpress.helper;
...
import com.projeto.camfexpress.activity.PassageiroActivity;
...
public class UsuarioFirebase {
    ...
    /*public String dadosUsuarioLogado(){
        FirebaseUser user = getUsuarioAtual();
        DatabaseReference usuariosRef = ConfiguracaoFirebase.getFirebaseDatabase().child("usuarios").child(user.getPhoneNumber());
        usuariosRef.addListenerForSingleValueEvent(new ValueEventListener() {
            public DataSnapshot onDataChange(DataSnapshot dataSnapshot) {
                return dataSnapshot;
            }
